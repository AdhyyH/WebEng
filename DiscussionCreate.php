                    ...
                    <div class="card-body">
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="taskName" placeholder="Enter topic">
                            </div>
                            <div class="mb-3">
                                <label for="taskDescription" class="form-label">Topic description</label>
                                <textarea class="form-control" id="taskDescription" rows="3" placeholder="Enter topic description"></textarea>
                            </div>
