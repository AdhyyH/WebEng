                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="expertDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="addExpertData.php" method="POST">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="Research">Research Interest</label>
                                                <select class="form-control" id="Research" required>
                                                    <option value="1">Computer System Research Group</option>
                                                    <option value="2">Virtual Simulation & Computing</option>
                                                    <option value="3">Machine Intelligence Research Group</option>
                                                    <option value="4">Cyber Security Interest Group</option>
                                                    <option value="5">Software Engineering</option>
                                                    <option value="6">Knowledge Engineering & Computational Linguistic</option>
                                                    <option value="7">Data Science & Simulation Modeling</option>
                                                    <option value="8">Database Technology & Information System</option>
                                                    <option value="9">Educational Technology (EduTech)</option>
                                                    <option value="10">Image Signal Processing</option>
                                                    <option value="11">Computer Network & Research Group</option>
                                                    <option value="12">Soft Computing & Optimization</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" id="Category" required>
                                                    <option value="1">BCN</option>
                                                    <option value="2">BCS</option>
                                                    <option value="3">BCG</option>
                                                </select>
                                            </div>
