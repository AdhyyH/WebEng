                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="taskName" placeholder="Enter email">
                        </div>
                        <div class="mb-3">
                            <label for="taskName" class="form-label">Social media</label>
                            <input type="text" class="form-control" id="taskName" placeholder="Enter social media link here">
                        </div>
