                                    ...
                                    <form action="addUserDataAdmin.php" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="ic" placeholder="Enter IC number" name="ic" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="phonenum">Phone Number</label>
                                                <input type="text" class="form-control" id="phoneum" placeholder="Enter phone number" name="phonenum" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="eduhist" rows="3" placeholder="Enter education history" name="eduhist" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="address">Address</label>
                                            <textarea class="form-control" id="address" rows="5" placeholder="Enter address" name="address" required></textarea>
                                        </div>
